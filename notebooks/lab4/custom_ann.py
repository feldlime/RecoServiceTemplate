...
class AnnRecommender():
    ...
    def recommend_single(self, id: int, n_recos: int | None = None):
        if n_recos is None:
    ...
    def _transform_embeddings_(self, embeddings, embedd_type: Literal['items', 'users']):
